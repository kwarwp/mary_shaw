...
class Game():
    def __init__(self):
        ...
        self.dwarf = Character(IMG_DWARF, self.cena, 0, 200, 248, 350, DWARF, self.left_margin)
        self.apple = Character(IMG_APPLE, self.cena, 0, 400, 248, 350, APPLE, self.left_margin)
