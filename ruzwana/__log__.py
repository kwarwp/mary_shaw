...
'''},
{'date': 'Sat Oct 12 2019 12:13:32.922 GMt-0300 (Horário Padrão de Brasília) -X- SuPyGirls -X-',
'error': '''Traceback (most recent call last):
  module _core.main line 160
    dialog.action(lambda *_: self.start()
  module _core.supygirls_factory line 135
  ...
  module <module> line 6
    INVENTARIO.help()
AttributeError: 'Inventario' object has no attribute 'help'
'''},
{'date': 'Sat Oct 12 2019 12:15:33.375 GMt-0300 (Horário Padrão de Brasília) -X- SuPyGirls -X-',
'error': '''Traceback (most recent call last):
  module _core.main line 160
    dialog.action(lambda *_: self.start()
  module _core.supygirls_factory line 135
  ...
  module _core.supygirls_factory line 295
    exec(self.code, glob)  # dict(__name__="__main__"))
  module <module> line 6
    print(help(INVENTARIO.inicia()))
IOError: File http://supygirls.pythonanywhere.com/js/builtins_docstrings.js not found
'''},
{'date': 'Sat Oct 12 2019 12:16:25.886 GMt-0300 (Horário Padrão de Brasília) -X- SuPyGirls -X-',
'error': '''Traceback (most recent call last):
  module _core.main line 160
    dialog.action(lambda *_: self.start()
  module _core.supygirls_factory line 135
  ...
  module _core.supygirls_factory line 295
    exec(self.code, glob)  # dict(__name__="__main__"))
  module <module> line 6
    print(help(INVENTARIO.retira))
AttributeError: 'Inventario' object has no attribute 'retira'
'''},
{'date': 'Sat Oct 12 2019 12:16:32.639 GMt-0300 (Horário Padrão de Brasília) -X- SuPyGirls -X-',
'error': '''Traceback (most recent call last):
  module _core.main line 160
    dialog.action(lambda *_: self.start()
  module _core.supygirls_factory line 135
  ...
  module _core.supygirls_factory line 295
    exec(self.code, glob)  # dict(__name__="__main__"))
  module <module> line 6
    print(help(INVENTARIO.remove))
AttributeError: 'Inventario' object has no attribute 'remove'
'''},